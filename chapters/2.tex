...
\begin{enumerate}
    ...
    \istinputlisting[firstline=8, lastline=12]{src/1174057_teori.py}
    \item Kode untuk meminta input dari user dan bagaimana melakukan output ke layar
	\istinputlisting[firstline=67, lastline=68]{src/1174057_teori.py}
	...
	\istinputlisting[firstline=71, lastline=94]{src/1174057_teori.py}
    \item Perulangan
	Terdapat dua jenis perulangan di dalam phyton yaitu perulangan while dan perulangan for
	\istinputlisting[firstline=97, lastline=99]{src/1174057_teori.py}
	\istinputlisting[firstline=102, lastline=105]{src/1174057_teori.py}
	...
	\istinputlisting[firstline=108, lastline=111]{src/1174057_teori.py}
	\istinputlisting[firstline=114, lastline=119]{src/1174057_teori.py}
	\istinputlisting[firstline=122, lastline=129]{src/1174057_teori.py}
...
Cara pemakaian try except adalah sebagai berikut :
	\istinputlisting[firstline=132, lastline=138]{src/1174057_teori.py}
...
\begin{enumerate}
    ...
    \istinputlisting[firstline=11, lastline=20]{src/1174057_praktek.py}
    \item Jawaban soal no 2
    \istinputlisting[firstline=24, lastline=28]{src/1174057_praktek.py}
    \item Jawaban soal no 3
    \istinputlisting[firstline=33, lastline=37]{src/1174057_praktek.py}
    \item Jawaban soal no 4
    \istinputlisting[firstline=40, lastline=41]{src/1174057_praktek.py}
    \item Jawaban soal no 5
    \istinputlisting[firstline=44, lastline=56]{src/1174057_praktek.py}
    \item Jawaban soal no 6
    \istinputlisting[firstline=59, lastline=60]{src/1174057_praktek.py}
    \item Jawaban soal no 7
    \istinputlisting[firstline=63, lastline=64]{src/1174057_praktek.py}
    \item Jawaban soal no 8
    \istinputlisting[firstline=67, lastline=71]{src/1174057_praktek.py}
    \item Jawaban soal no 9
    \istinputlisting[firstline=74, lastline=74]{src/1174057_praktek.py}
    \item Jawaban soal no 10
    \istinputlisting[firstline=77, lastline=77]{src/1174057_praktek.py}
    \item Jawaban soal no 11
    \istinputlisting[firstline=80, lastline=80]{src/1174057_praktek.py}
\end{enumerate}

\subsection{Keterampilan dan penanganan eror}
    \istinputlisting[firstline=10, lastline=17]{src/errr2.py}
